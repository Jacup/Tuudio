...
namespace Tuudio.Infrastructure.Migrations
{
    ...
    [Migration("20240808211934_entryApi")]
            ...
            modelBuilder.Entity("Tuudio.Domain.Entities.Entries.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EntryDate = new DateTime(2024, 8, 8, 23, 19, 34, 130, DateTimeKind.Local).AddTicks(700),
                        ...
                        new
                        {
                            ...
                            ClientId = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EntryDate = new DateTime(2024, 8, 8, 23, 19, 34, 130, DateTimeKind.Local).AddTicks(746),
