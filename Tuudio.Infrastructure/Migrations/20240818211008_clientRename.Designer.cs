...
namespace Tuudio.Infrastructure.Migrations
{
    ...
    [Migration("20240818211008_clientRename")]
    partial class clientRename
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tuudio.Domain.Entities.Entries.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EntryDate = new DateTime(2024, 8, 18, 23, 10, 8, 57, DateTimeKind.Local).AddTicks(6455),
                        ...
                        new
                        {
                            ...
                            ClientId = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EntryDate = new DateTime(2024, 8, 18, 23, 10, 8, 57, DateTimeKind.Local).AddTicks(6503),
